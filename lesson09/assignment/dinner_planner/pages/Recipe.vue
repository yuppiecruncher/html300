...
export default {
  ...
  // note: current API request limit is maxed. Work with some dummy data tomorrow and only use the requests if necessary.
  // mounted () {
  //   axios
  //   .get('https://www.food2fork.com/api/search?key=512ad354b2b8443cec7e1fa308133ae6&q=chicken')
